...
<div class="left-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Bookboard</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row bg-white m-l-0 m-r-0 box-shadow ">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Popular Chart</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body browser">
                                <p class="f-w-600">Science <span class="pull-right">85%</span></p>
                                <div class="progress ">
                                ...
                                <p class="m-t-30 f-w-600">Art<span class="pull-right">90%</span></p>
                                <div class="progress">
                                ...
                                <p class="m-t-30 f-w-600">Literature<span class="pull-right">65%</span></p>
                                <div class="progress">
                                ...
                                <p class="m-t-30 f-w-600">Economy<span class="pull-right">65%</span></p>
                                <div class="progress">
								...
								<p class="m-t-30 f-w-600">History<span class="pull-right">65%</span></p>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2018 All rights reserved. Developed by Biubi.</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
